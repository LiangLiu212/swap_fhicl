...
physics.analyzers.wcpselection.FileType: "prodgenie_numi_intrinsic_nue_overlay_${FT_STREAM}"
physics.analyzers.wcpweights.FileType: "prodgenie_numi_intrinsic_nue_overlay_${FT_STREAM}"
