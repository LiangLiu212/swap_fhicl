...
if [ "$crt_status" -eq "0" ]; then
    ...
    cat backup_${FCL}.fcl  | sed "s/reco_uboone_overlay_mcc9_8_driver_crt_numi/copy/g" > $FCL
    cat $FCL
    cat wrapper.fcl
    mv wrapper.fcl backup_wrapper.fcl
    cat backup_wrapper.fcl | sed "s/reco_uboone_overlay_mcc9_8_driver_crt_numi/copy/g" > wrapper.fcl
    cat wrapper.fcl
...
then
        ...
        cat $FCL
        mv $FCL backup_${FCL}.fcl
        cat backup_${FCL}.fcl  | sed "s/reco_uboone_overlay_mcc9_8_driver_crt_numi/reco_uboone_overlay_mcc9_8_driver_crt_numi/g" > $FCL
        cat $FCL
        cat wrapper.fcl
        mv wrapper.fcl backup_wrapper.fcl
        cat backup_wrapper.fcl | sed "s/reco_uboone_overlay_mcc9_8_driver_crt_numi/reco_uboone_overlay_mcc9_8_driver_crt_numi/g" > wrapper.fcl
        cat wrapper.fcl
