...
TEMPLATE_FHILE="reco_uboone_overlay_mcc9_8_driver_crt_numi"
PICKED_FHICL=""
...
then
        echo "run run2b fhicl reco_uboone_overlay_mcc9_8_driver_crt_numi.fcl"
        PICKED_FHICL="reco_uboone_overlay_mcc9_8_driver_crt_numi"
elif [ "$run_number" -ge "0013697"  ] && [  "0014116" -ge "$run_number"  ];    # in the run3 run number interval
then
        echo "run run3a fhicl reco_uboone_overlay_mcc9_8_driver_crt_numi.fcl"
        PICKED_FHICL="reco_uboone_overlay_mcc9_8_driver_crt_numi"
elif [ "$run_number" -ge "14117"  ] && [  "0018960" -ge "$run_number"  ];    # in the run3 run number interval
then
        echo "run run3b fhicl reco_uboone_overlay_mcc9_8_driver_crt_numi.fcl"
        PICKED_FHICL="reco_uboone_overlay_mcc9_8_driver_crt_numi"
...
then
        echo "run run4a fhicl reco_uboone_overlay_mcc9_8_driver_crt_numi.fcl"
        PICKED_FHICL="reco_uboone_overlay_mcc9_8_driver_crt_numi"
...
then
        echo "run run4b fhicl reco_uboone_overlay_mcc9_8_driver_crt_numi.fcl"
        PICKED_FHICL="reco_uboone_overlay_mcc9_8_driver_crt_numi"
...
then
        echo "run run4c fhicl reco_uboone_overlay_mcc9_8_driver_crt_numi.fcl"
        PICKED_FHICL="reco_uboone_overlay_mcc9_8_driver_crt_numi"
